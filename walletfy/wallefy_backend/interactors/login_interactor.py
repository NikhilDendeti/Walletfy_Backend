from walletfy.wallefy_backend.dto.user_dto.dtos import LoginResponseDTO
...
class LoginInteractor:
    def __init__(self, storage: UserDB, authentication: UserAuthentication, response: LoginResponse):
