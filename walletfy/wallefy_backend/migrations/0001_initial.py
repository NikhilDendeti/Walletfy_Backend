# Generated by Django 4.2.16 on 2024-10-21 08:20
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city_name', models.CharField(choices=[('Alwal', 'ALWAL'), ('Amberpet', 'AMBERPET'), ('Ameerpet', 'AMEERPET'), ('Attapur', 'ATTAPUR'), ('Bachupally', 'BACHUPALLY'), ('Banjara Hills', 'BANJARA_HILLS'), ('Begumpet', 'BEGUMPET'), ('Charminar', 'CHARMINAR'), ('Dilsukhnagar', 'DILSUKHNAGAR'), ('ECIL', 'ECIL'), ('Gachibowli', 'GACHIBOWLI'), ('Hafiz Baba Nagar', 'HAFIZ_BABA_NAGAR'), ('Hayath Nagar', 'HAYATH_NAGAR'), ('Himayatnagar', 'HIMAYATNAGAR'), ('Jeedimetla', 'JEEDIMETLA'), ('JNTU', 'JNTU'), ('Karkhana', 'KARKHANA'), ('Kompally', 'KOMPALLY'), ('Kondapur', 'KONDAPUR'), ('Kukatpally', 'KUKATPALLY'), ('LB Nagar', 'LB_NAGAR'), ('Madhapur', 'MADHAPUR'), ('Malakpet', 'MALAKPET'), ('Manikonda', 'MANIKONDA'), ('Masab Tank', 'MASAB_TANK'), ('Medchal Road', 'MEDCHAL_ROAD'), ('Miyapur', 'MIYAPUR'), ('Mokila', 'MOKILA'), ('Moosapet', 'MOOSAPET'), ('Nagole', 'NAGOLE'), ('Narayanguda', 'NARAYANGUDA'), ('Nizampet', 'NIZAMPET'), ('Patancheru', 'PATANCHERU'), ('Peerzadiguda', 'PEERZADIGUDA'), ('Q City', 'Q_CITY'), ('Sainikpuri', 'SAINIKPURI'), ('Sangareddy', 'SANGAREDDY'), ('Saroor Nagar', 'SAROOR_NAGAR'), ('Serilingampally', 'SERILINGAMPALLY'), ('Shamshabad', 'SHAMSHABAD'), ('Sivarampalli', 'SIVARAMPALLI'), ('Suraram', 'SURARAM'), ('Tarnaka', 'TARNAKA'), ('Toli Chowki', 'TOLI_CHOWKI'), ('Uppal', 'UPPAL'), ('Vanasthalipuram', 'VANASTHALIPURAM')], max_length=50, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='User',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_preference', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='wallefy_backend.userpreferencedetails')),
                ('user_profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='wallefy_backend.userprofile')),
            ],
            options={
                'ordering': ['-date'],
            },
