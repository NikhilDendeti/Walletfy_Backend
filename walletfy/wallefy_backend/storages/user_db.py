...
from wallefy_backend.dto.dtos import ProfileDTO, userDetailsDTO, UserProfileDTO
from wallefy_backend.exceptions import InvalidUserException, \
    UserAlreadyExistsException
from wallefy_backend.models import *
...
class UserDB:
    ...
    @staticmethod
    def create_user_for_signup(email, password, username, full_name, role,
                               gender):
    ...
    def profile(user_id) -> UserProfileDTO:
        ...
        user_salary = UserPreferenceDetails.objects.get(user=user)
